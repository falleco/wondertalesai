...
export function Pagination({
  ...
  return (
    <nav aria-label="Pagination" className="text-[#344054] font-medium">
...
function PaginationEllipsis() {
  return (
    <button
      type="button"
      className="size-10 rounded-lg shrink-0 hover:bg-gray-200/50 dark:hover:bg-gray-800/80 cursor-default"
    >
      ...
    </button>
  );
