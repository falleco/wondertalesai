...
export default function DashboardSidebar({
  ...
  return (
    <aside
      className={`absolute inset-y-0 overflow-y-auto left-0 z-40 w-[288px] bg-white dark:bg-dark-primary border-r border-gray-100 dark:border-gray-800 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:sticky lg:top-0 ${
        sidebarOpen ? "translate-x-0" : "-translate-x-full"
      }`}
    >
      <div className="flex flex-col h-full">
        <div className="flex-[1_1_0]">
          <h3 className="px-10 mb-4 pt-10 text-xs text-gray-500 dark:text-gray-400">
            Main Menu
          </h3>
            ...
            {menuItems.map(({ href, label, icon }) => {
              ...
              return (
                <Link
                  ...
                  href={href}
                  className={cn(
                    "group flex gap-2.5 items-center px-10 py-3 text-sm font-medium relative",
                    isActive
                      ? "text-primary-500"
