// import { verifyResetToken } from '@/actions/user';
import { GradientBlob2 } from "@web/components/gradient-blob";
...
export default async function ResetPasswordPage({ searchParams }: PageProps) {
  ...
  if (token) {
    const tokenVerification = null; //await verifyResetToken(token);
